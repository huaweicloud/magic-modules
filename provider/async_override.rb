...
module Provider
  ...
  class AsyncOverride < Api::Object
    module Fields
    ...
    def validate
      ...
      check_optional_property :custom_status_check_func, String
    end
    ...
    def ensure_property_fields
      Api::Async.send(:include, Fields) # override ...
    ...
    def our_override_modules
      self.class.included_modules.select do |mod|
        mod == Provider::AsyncOverride::Fields
      end
    end
    ...
    def require_module(clazz)
      raise "Api::Type did not include required #{clazz} module" \
        unless Api::Async.included_modules.include?(clazz)
